...
// Valor em centavos permanece vindo do front; apenas garantimos que é inteiro
...
// Payload conforme GhostsPays v2
$payload = [
    'paymentMethod' => 'PIX',
    'amount' => $valorConvertido, // em centavos
    'description' => $titulo,
...
// Monta Authorization Basic (SecretKey:CompanyId)
...
// Normaliza estrutura de resposta v2 para o que o front espera
$tx = $data['data'] ?? $data;
$pix = $tx['pix'] ?? ($tx['data']['pix'] ?? []);
// Tenta extrair o código copia-e-cola em diferentes possíveis chaves
